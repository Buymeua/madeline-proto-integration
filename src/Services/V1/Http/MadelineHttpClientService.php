...
readonly class MadelineHttpClientService extends HttpClientService
{
	...
	public function newPerformRequest(string $method, string $uri, array $params = [], array $headers = []): array
	{
		Log::info("newPerformRequest");
		return parent::tryPerformRequest($method, $uri, $params, $headers);
	}
