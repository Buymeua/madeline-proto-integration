...
use Buyme\MadelineProtoIntegration\Services\V1\Telegram\Account\TelegramAccountService;
...
class MadelineProtoIntegrationServiceProvider extends ServiceProvider
{
    ...
    private function registerFacades(): void
    {
        ...
        $this->app->singleton('mpi-account', function (Application $app) {
            return $app->make(TelegramAccountService::class);
        });
    }
}
